...
let generateShop =()=>{ //Array function

    return (shop.innerHTML = targyakAdata.map((x)=>{
        let {id,name,price,leiras,img} =x;
        ...
        <div id=termek-id-${id} class="festek item">
                ...
                <p><span>Mennyiség:</span> 15 liter</p>
                    ...
                    <div class="d-flex justify-content-center">
                        <button onclick="hozzaadas(${id})" type="button" class="vasarlas btn btn-primary">Vásárlás</button>
